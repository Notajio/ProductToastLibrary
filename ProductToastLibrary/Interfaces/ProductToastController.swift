...
@objc public class ProductToastHelper: NSObject {
    ...
    @objc public class func showSuccessCard(sender: UIViewController, handler: (() -> Void)?) {
    ...
    @objc public class func showErrorCard(sender: UIViewController, errorMessage: String, handler: (() -> Void)?) {
    ...
    @objc public class func showWarningCard(sender: UIViewController, handler: (() -> Void)?) {
    ...
    @objc public class func showSuccessStatusBar(sender: UIViewController, handler: (() -> Void)?) {
    ...
    @objc public class func showErrorStatusBar(sender: UIViewController, handler: (() -> Void)?) {
